    ...
    <div class="col-lg-12">
        <div class="breadcrumb-content d-flex flex-wrap justify-content-between align-items-center">
            <div class="section-heading">
                <h2 class="sec__title line-height-45">Welcome, {{Auth::user()->name}}</h2>
            </div><!-- end section-heading -->
            <ul class="list-items d-flex align-items-center">
                <li class="active__list-item"><a href="index.html">Home</a></li>
                <li class="active__list-item">Users</li>
                <li>Dashboard</li>
            </ul>
...
<div class="row mt-5">
    <div class="col-lg-4 column-lg-6 column-md-6">
        <div class="overview-item">
            <div class="icon-box bg-1 mb-0 d-flex align-items-center">
                ...
                <div class="info-content">
                    ...
                    <h4 class="info__title font-size-16 mt-2">Total User Referred</h4>
        ...
        <div class="overview-item">
            <div class="icon-box bg-2 mb-0 d-flex align-items-center">
                ...
                <div class="info-content">
                    ...
                    <h4 class="info__title font-size-16 mt-2">Total E-Book Downloaded</h4>
                </div><!-- end info-content -->
            </div>
        </div>
    </div><!-- end col-lg-3 -->
        ...
        <div class="overview-item">
            <div class="icon-box bg-4 mb-0 d-flex align-items-center">
                ...
                <div class="info-content">
                    ...
                    <h4 class="info__title font-size-16 mt-2">Total Course Applied</h4>
                </div><!-- end info-content -->
            </div>
        </div>
    </div><!-- end col-lg-3 -->
