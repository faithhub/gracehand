...
<head>
    ...
    <title>GraceHands User Dashboard - {{$title ?? ''}}</title>
    <!-- Favicon -->
    ...
    <!-- Template CSS Files -->
    @include('users.layouts.includes.style')
    @include('users.layouts.includes.alert')
</head>
<body>
<!-- start per-loader -->
...
<section class="dashboard-area">
    @include('users.layouts.includes.sidemenu')
...
<!-- Template JS Files -->
@include('users.layouts.includes.script')
