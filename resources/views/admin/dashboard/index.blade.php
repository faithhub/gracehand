    ...
    <div class="col-lg-12">
        <div class="breadcrumb-content d-flex flex-wrap justify-content-between align-items-center">
            <div class="section-heading">
                <h2 class="sec__title line-height-45">Welcome, Admin {{Auth::user()->name}}</h2>
        ...
        <div class="overview-item">
            <div class="icon-box bg-1 mb-0 d-flex align-items-center">
                ...
                <div class="info-content">
                    <span class="info__count">{{$user_count}}</span>
                    <h4 class="info__title font-size-16 mt-2">Total Users</h4>
        ...
        <div class="overview-item">
            <div class="icon-box bg-2 mb-0 d-flex align-items-center">
                ...
                <div class="info-content">
                    ...
                    <h4 class="info__title font-size-16 mt-2">Total E-Book</h4>
                </div><!-- end info-content -->
            </div>
        </div>
    </div><!-- end col-lg-3 -->
        ...
        <div class="overview-item">
            <div class="icon-box bg-4 mb-0 d-flex align-items-center">
                ...
                <div class="info-content">
                    ...
                    <h4 class="info__title font-size-16 mt-2">Total Course</h4>
                </div><!-- end info-content -->
            </div>
        </div>
    </div><!-- end col-lg-3 -->
