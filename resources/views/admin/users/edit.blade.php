    ...
    <div class="col-lg-12">
        <div class="breadcrumb-content d-flex flex-wrap justify-content-between align-items-center">
            <div class="section-heading">
                <h2 class="sec__title line-height-45">Edit {{$user['name']}}</h2>
...
<form method="POST" action="{{ url('admin/edit-user') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row mt-5">       
                ...
                <div class="user-form-action">
                    <div class="billing-form-item">
                        <div class="billing-title-wrap">
                            <h3 class="widget-title pb-0">{{$user['name']}} Profile</h3>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="email" value="{{$user['email']}}" readonly disabled>
                                            </div>
                                        </div><!-- end input-box -->
                                    </div><!-- end col-lg-6 -->
                                    <div class="col-lg-6">
        ...
        <div class="col-lg-12">
            <div class="user-form-action">
                <div class="billing-form-item">
                    <div class="billing-title-wrap">
                        <h3 class="widget-title pb-0">{{$user['name']}} Contact Information</h3>
                        <div class="title-shape margin-top-10px"></div>
                    </div><!-- billing-title-wrap -->
                    <div class="billing-content">
                        <div class="contact-form-action">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control @error('mobile') is-invalid @enderror" type="number" name="mobile" value="{{$user['mobile']}}" placeholder="+1 246-345-0695">
                                                @error('mobile')
                                                <span class="invalid-feedback mb-2" role="alert" style="display: block">
                                                  <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control @error('address') is-invalid @enderror" type="text" name="address" value="{{$user['address']}}" placeholder="Krakowskie Przedmiescie 12/1200-041 Warsaw">
                                                @error('address')
                                                <span class="invalid-feedback mb-2" role="alert" style="display: block">
                                                  <strong>{{ $message }}</strong>
                                                </span>
        ...
        <div class="col-lg-12">
            <div class="edit-profile-wrap">
                <div class="user-form-action">
                    <div class="billing-form-item">
                        <div class="billing-title-wrap">
                            <h3 class="widget-title pb-0">{{$user['name']}} Status</h3>
                            <div class="title-shape margin-top-10px"></div>
                        </div><!-- billing-title-wrap -->
                        <div class="billing-content">
                            <div class="contact-form-action">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                <select class="search-tag-option-field @error('status') is-invalid @enderror" name="status">
