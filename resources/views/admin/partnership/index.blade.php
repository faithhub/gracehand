                                        ...
                                        <td width="40%">                                        
                                            <div class="bread-details d-flex">
                                                <div class="bread-img flex-shrink-0">
                                                    <a href="{{ url('admin/view-partnership', $user->id) }}" class="d-block">
                                                        <img src="{{ asset('images/avatar.jpg') ??  asset('uploads/profile_pictures/'.Auth::user()->avatar)}}" alt="{{$user->first_name  }}">
                                                    </a>
                                                </div>
                                                <div class="manage-candidate-content">
                                                    <h2 class="widget-title pb-2"><a href="{{ url('admin/view-partnership', $user->id) }}" class="color-text-2"><i class="la la-user mr-1"></i>{{$user->fullName}}</a></h2>
                                        ...
                                        <td class="text-center">
                                            <div class="manage-candidate-wrap">
                                                <div class="bread-action pt-0">
                                                    <ul class="info-list">
                                                        <li class="d-inline-block"><a href="{{ url('admin/view-partnership', $user->id) }}" ><i class="la la-eye" data-toggle="tooltip" data-placement="top" title="View"></i></a></li>
