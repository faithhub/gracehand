    ...
    <div class="billing-form-item">
      <div class="billing-title-wrap">
        ...
        <div class="text-right">
          <a href="{{ url('admin/add-full-training') }}" class="btn btn-success">Create New Training</a>
        </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                {{-- <td>
                  <div class="bread-details d-flex">
                    <div class="manage-candidate-content">
                      <h3 class="widget-title pb-2 text-success"><a href="#" class="color-text-2">{{$training->trainingType}}</a></h3>
                    </div><!-- end manage-candidate-content -->
                  </div>
                </td> --}}
                <td>
