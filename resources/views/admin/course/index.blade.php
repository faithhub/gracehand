    ...
    <div class="col-lg-12">
        <div class="breadcrumb-content d-flex flex-wrap justify-content-between align-items-center">
            <div class="section-heading">
                <h2 class="sec__title line-height-45">Courses</h2>
        ...
        <div class="billing-form-item">
            <div class="billing-title-wrap">
                ...
                <div class="text-right">                    
                    <a href="{{ url('admin/add-course') }}" class="btn btn-success">Add New Course</a>
                </div>
            ...
            <div class="billing-content pb-0">
                    ...
                    @else
                        <div class="text-center mb-4 mt-3">
                            <h2 class="text-black" style="color: black; font-family: Georgia, 'Times New Roman', Times, serif">No Courses Created yet, Check back later</h2>
                        </div>
                    @endif
                </div>
