  ...
  <div class="dashboard-nav-container">
    ...
    <div class="side-menu-wrap">
      <ul class="side-menu-ul">
        ...
        <li class="{{ request()->is('admin/partnership*') || request()->is('admin/view-partnership*')  ? 'page-active' : '' }}"><a href="{{ url('admin/partnership') }}"><i class="la la-user icon-element"></i> Partnerships</a></li>
        <li class="{{ request()->is('admin/full-training*')  || request()->is('admin/short-training*') || request()->is('admin/view-training*') || request()->is('admin/add-short-training*') || request()->is('admin/add-full-training*')  ? 'page-active' : '' }}">
        ...
        <!-- <li class="{{ request()->is('admin/about-us*')  ? 'page-active' : '' }}"><a href="{{ route('admin.web-settings') }}"><i class="la la-bookmark icon-element"></i>Web Settings</a></li> -->
        ...
        <li class="{{ request()->is('admin/profile*')  ? 'page-active' : '' }}"><a href="{{ url('admin/profile') }}"><i class="la la-user icon-element"></i> View Profile</a></li>
